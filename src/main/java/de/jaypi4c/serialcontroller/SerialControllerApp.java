...
public class SerialControllerApp {
    ...
    static void main() {
        Channel<LTV> conn = ChannelBuilder.builder().protocol(new LTV()).channelFactory(SimpleChannel::new).build();
